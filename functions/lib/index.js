...
exports.stripeConnectWebhook = exports.cancelPreorderPayment = exports.getPreorderPaymentStatus = exports.createPreorderPaymentIntent = exports.getOrganizerStripeAccountLink = exports.disconnectOrganizerStripeAccount = exports.checkOrganizerStripeAccountStatus = exports.createOrganizerStripeConnectAccount = exports.getStripeAccountLink = exports.disconnectStripeAccount = exports.checkStripeAccountStatus = exports.createStripeConnectAccount = exports.triggerSquareSync = exports.syncSquarePayments = exports.disconnectSquare = exports.refreshSquareTokens = exports.exchangeSquareToken = exports.cancelTicketPurchase = exports.getEventTicketSummary = exports.validateTicket = exports.createTicketCheckoutSession = exports.secureStripeWebhook = exports.monitorPaymentSecurity = exports.generatePerformanceDashboard = exports.collectPerformanceMetrics = exports.dailyBillingNotifications = exports.weeklyUsageAnalytics = exports.dailySubscriptionHealthCheck = exports.monthlyUsageReset = exports.resetUsageLimits = exports.getUserUsageAnalytics = exports.enforceUsageLimit = exports.trackUsage = exports.validateMultipleFeatures = exports.validateUsageLimit = exports.validateFeatureAccess = exports.createFoundingPartnerCoupon = exports.validatePromoCode = exports.stripeWebhookFallback = exports.stripeWebhook = exports.cancelSubscriptionEnhanced = exports.cancelSubscription = exports.verifySubscriptionSession = exports.stripeWebhookAlt = exports.createCheckoutSession = exports.createVendorApplicationPaymentIntent = exports.createTicketPaymentIntent = exports.createProductCheckoutSession = exports.createProductPaymentIntent = exports.createPaymentIntent = void 0;
exports.extractFlyerData = exports.onApplicationUpdated = exports.onApplicationCreated = exports.expireApplicationsScheduled = exports.testEmailFunction = exports.sendVendorApplicationConfirmationEmail = exports.sendOrderStatusUpdateEmail = exports.sendTicketConfirmationEmail = exports.sendOrderConfirmationEmail = exports.triggerPopupReminders = exports.thursdayMorningReminders = exports.mondayMorningReminders = exports.scheduledBasketCleanup = exports.onVendorPostDeleted = exports.getVendorSalesSummary = exports.backfillStripePreordersToSales = exports.syncStripePreorderToSales = exports.testStripeWebhook = void 0;
...
exports.createPaymentIntent = functions.https.onCall(async (data, context) => {
    ...
    if (!context.auth) {
        throw new functions.https.HttpsError('unauthenticated', 'Must be authenticated to create payment intent');
    }
    // Verify user is creating payment intent for themselves
    if (context.auth.uid !== data.userId) {
        throw new functions.https.HttpsError('permission-denied', 'Can only create payment intent for authenticated user');
    }
    try {
        ...
        if (!price.unit_amount) {
            throw new functions.https.HttpsError('invalid-argument', 'Price does not have a unit amount');
        }
        ...
        if (data.promoCode) {
            try {
                    ...
                    if (promotionCodes.data.length > 0) {
                        ...
                        if (coupon.percent_off) {
                            ...
                            if (isNaN(calculatedAmount) || !isFinite(calculatedAmount) || calculatedAmount < 0) {
                                ...
                                throw new functions.https.HttpsError('failed-precondition', 'Invalid discount calculation for percentage coupon');
                            }
                            ...
                            if (isNaN(calculatedAmount) || !isFinite(calculatedAmount)) {
                                ...
                                throw new functions.https.HttpsError('failed-precondition', 'Invalid discount calculation for fixed amount coupon');
                            }
                            discountedAmount = calculatedAmount;
                        ...
                        throw new functions.https.HttpsError('failed-precondition', 'Invalid promo code');
                    }
                }
            }
            catch (promoError) {
                ...
                if (promoError instanceof stripe_1.default.errors.StripeError) {
                    const stripeError = promoError;
                    throw new functions.https.HttpsError('failed-precondition', `Stripe error processing promo code: ${stripeError.message}`);
                }
                throw new functions.https.HttpsError('failed-precondition', `Unable to process promo code "${data.promoCode}": ${promoError instanceof Error ? promoError.message : 'Unknown error'}`);
            }
        }
...
exports.createProductPaymentIntent = functions.https.onCall(async (data, context) => {
    // Verify user is authenticated
    if (!context.auth) {
        throw new functions.https.HttpsError('unauthenticated', 'Must be authenticated to make a purchase');
    }
    // Verify user is creating payment for themselves
    if (context.auth.uid !== data.userId) {
        throw new functions.https.HttpsError('permission-denied', 'Can only create payment for authenticated user');
    }
    try {
        ...
        // Create payment intent
        const paymentIntent = await stripe.paymentIntents.create({
            amount: Math.round(config.total * 100),
            currency: 'usd',
            customer: customer.id,
        ...
        const transactionData = {
            ...
            recipientPayout: config.subtotal * 0.94,
...
exports.createProductCheckoutSession = functions.https.onCall(async (data, context) => {
    // Verify user is authenticated
    if (!context.auth) {
        throw new functions.https.HttpsError('unauthenticated', 'Must be authenticated to make a purchase');
    }
...
exports.createTicketPaymentIntent = functions.https.onCall(async (data, context) => {
    ...
    try {
        ...
        const ticketBatch = {
            ...
            total: config.total,
            status: 'reserved',
            expiresAt: admin.firestore.Timestamp.fromDate(new Date(Date.now() + 10 * 60 * 1000) // 10 minute reservation
            ),
            createdAt: admin.firestore.FieldValue.serverTimestamp(),
        };
        ...
        throw new functions.https.HttpsError('internal', 'Failed to create ticket payment');
    }
});
...
exports.createVendorApplicationPaymentIntent = functions.https.onCall(async (data, context) => {
    // Verify user is authenticated
    if (!context.auth) {
        throw new functions.https.HttpsError('unauthenticated', 'Must be authenticated to pay application fees');
    }
    // Verify user is creating payment for themselves
    if (context.auth.uid !== data.userId) {
        throw new functions.https.HttpsError('permission-denied', 'Can only pay application fees for authenticated user');
    }
    try {
        const { config, customerEmail, userId } = data;
        ...
        if (applicationData?.status !== 'approved') {
            throw new functions.https.HttpsError('failed-precondition', 'Application must be approved before payment');
        }
        // Verify the application hasn't been paid yet
        if (applicationData?.paymentStatus === 'paid') {
            throw new functions.https.HttpsError('failed-precondition', 'Application has already been paid');
        }
        // Verify the vendor is the one making the payment
        if (applicationData?.vendorId !== userId) {
            throw new functions.https.HttpsError('permission-denied', 'Can only pay for your own applications');
        }
        ...
        if (!organizerIntegrationDoc.exists) {
            throw new functions.https.HttpsError('failed-precondition', 'Organizer has not set up payment processing');
        }
        const stripeAccountId = organizerIntegrationDoc.data()?.stripe?.accountId;
        if (!stripeAccountId) {
            throw new functions.https.HttpsError('failed-precondition', 'Organizer Stripe account not configured');
        }
        // Verify Stripe Connect account is active
        const account = await stripe.accounts.retrieve(stripeAccountId);
        if (!account.charges_enabled) {
            throw new functions.https.HttpsError('failed-precondition', 'Organizer payment processing is not fully set up');
        }
        // Get or create Stripe customer
        let customer;
        const existingCustomers = await stripe.customers.list({
        ...
        const paymentIntent = await stripe.paymentIntents.create({
            ...
            application_fee_amount: Math.round(config.platformFee * 100),
            transfer_data: {
        ...
        throw new functions.https.HttpsError('internal', 'Failed to create vendor application payment');
    }
});
exports.createCheckoutSession = functions.https.onCall(async (data, context) => {
    // Verify user is authenticated
    if (!context.auth) {
        throw new functions.https.HttpsError('unauthenticated', 'Must be authenticated to create subscription');
    }
...
exports.stripeWebhookAlt = functions.https.onRequest(webhookApp);
    ...
    try {
        switch (event.type) {
            ...
            case 'payment_method.attached':
                ...
                break;
            case 'coupon.created':
                await handleCouponCreated(event.data.object);
                break;
            case 'coupon.deleted':
                await handleCouponDeleted(event.data.object);
                break;
            case 'coupon.updated':
                await handleCouponUpdated(event.data.object);
                break;
...
exports.verifySubscriptionSession = functions.https.onCall(async (data, context) => {
    // Verify user is authenticated
    if (!context.auth) {
        throw new functions.https.HttpsError('unauthenticated', 'Must be authenticated to verify session');
    }
    try {
...
exports.cancelSubscription = functions.https.onCall(async (data, context) => {
    // Verify user is authenticated
    if (!context.auth) {
        throw new functions.https.HttpsError('unauthenticated', 'Must be authenticated to cancel subscription');
    }
    // Verify user is cancelling their own subscription
    if (context.auth.uid !== data.userId) {
        throw new functions.https.HttpsError('permission-denied', 'Can only cancel own subscription');
    }
    try {
...
exports.cancelSubscriptionEnhanced = functions.https.onCall(async (data, context) => {
    // Verify user is authenticated
    if (!context.auth) {
        throw new functions.https.HttpsError('unauthenticated', 'Must be authenticated to cancel subscription');
    }
    ...
    try {
        ...
        if (data.cancellationType === 'end_of_period') {
            ...
            cancelledSubscription = await stripe.subscriptions.update(stripeSubscriptionId, { cancel_at_period_end: true });
            // Update Firestore
            await subscriptionDoc.ref.update({
            ...
            cancelledSubscription = await stripe.subscriptions.cancel(stripeSubscriptionId, { prorate: true } // This will create a prorated refund
            );
            // Update Firestore
            await subscriptionDoc.ref.update({
                status: 'cancelled',
...
mainWebhookApp.post('/*', express.raw({ type: 'application/json' }), async (req, res) => {
    // Handle CORS
...
exports.stripeWebhook = functions.https.onRequest(mainWebhookApp);
// Keep the original function approach as backup
exports.stripeWebhookFallback = functions.https.onRequest(async (req, res) => {
    const endpointSecret = functions.config().stripe.webhook_secret;
    const sig = req.headers['stripe-signature'];
    // Early validation
    if (!sig) {
...
async function handleProductPaymentSuccess(paymentIntent) {
...
async function handleVendorApplicationPaymentSuccess(paymentIntent) {
...
async function handleCouponCreated(coupon) {
    try {
...
async function handleCouponUpdated(coupon) {
    try {
...
exports.validatePromoCode = functions.https.onCall(async (data, context) => {
    // Verify user is authenticated
    if (!context.auth) {
        throw new functions.https.HttpsError('unauthenticated', 'Must be authenticated to validate promo code');
    }
    try {
        ...
        return {
            ...
            discount_amount: coupon.amount_off ? coupon.amount_off / 100 : undefined,
...
exports.validateFeatureAccess = functions.https.onCall(async (data, context) => {
    // Verify user is authenticated
    if (!context.auth) {
        throw new functions.https.HttpsError('unauthenticated', 'Must be authenticated to validate features');
    }
    // Verify user is checking their own features
    if (context.auth.uid !== data.userId) {
        throw new functions.https.HttpsError('permission-denied', 'Can only validate own features');
    }
    try {
...
exports.validateUsageLimit = functions.https.onCall(async (data, context) => {
    // Verify user is authenticated
    if (!context.auth) {
        throw new functions.https.HttpsError('unauthenticated', 'Must be authenticated to validate limits');
    }
    // Verify user is checking their own limits
    if (context.auth.uid !== data.userId) {
        throw new functions.https.HttpsError('permission-denied', 'Can only validate own limits');
    }
    try {
...
exports.validateMultipleFeatures = functions.https.onCall(async (data, context) => {
    // Verify user is authenticated
    if (!context.auth) {
        throw new functions.https.HttpsError('unauthenticated', 'Must be authenticated to validate features');
    }
...
function getDefaultLimit(limitName) {
    const freeLimits = {
        monthly_markets: 5,
...
// Helper functions
function getTierFromUserType(userType) {
    switch (userType) {
        case 'shopper':
            return 'shopperPro';
        case 'vendor':
...
exports.trackUsage = functions.https.onCall(async (data, context) => {
    // Verify user is authenticated
    if (!context.auth) {
        throw new functions.https.HttpsError('unauthenticated', 'Must be authenticated to track usage');
    }
    // Verify user is tracking their own usage
    if (context.auth.uid !== data.userId) {
        throw new functions.https.HttpsError('permission-denied', 'Can only track own usage');
    }
...
exports.enforceUsageLimit = functions.https.onCall(async (data, context) => {
    // Verify user is authenticated
    if (!context.auth) {
        throw new functions.https.HttpsError('unauthenticated', 'Must be authenticated to check limits');
    }
    // Verify user is checking their own limits
    if (context.auth.uid !== data.userId) {
        throw new functions.https.HttpsError('permission-denied', 'Can only check own limits');
    }
    try {
...
exports.getUserUsageAnalytics = functions.https.onCall(async (data, context) => {
    // Verify user is authenticated
    if (!context.auth) {
        throw new functions.https.HttpsError('unauthenticated', 'Must be authenticated to get analytics');
    }
    // Verify user is getting their own analytics
    if (context.auth.uid !== data.userId) {
        throw new functions.https.HttpsError('permission-denied', 'Can only get own analytics');
    }
    try {
        ...
        analytics.tierInfo = {
            currentTier: tier,
            limits,
            upgradeRecommended: analytics.recommendations.some((r) => r.type === 'upgrade_suggested'),
        };
        ...
        throw new functions.https.HttpsError('internal', 'Failed to generate usage analytics');
    }
});
// Reset usage limits (for scheduled or manual resets)
exports.resetUsageLimits = functions.https.onCall(async (data, context) => {
    // Only allow authenticated admin users or system calls
    if (!context.auth && data.resetType !== 'monthly') {
        throw new functions.https.HttpsError('unauthenticated', 'Must be authenticated for manual resets');
    }
    try {
        ...
        throw new functions.https.HttpsError('internal', 'Failed to reset usage limits');
    }
});
// Helper function to reset individual user usage
async function resetUserUsage(doc, resetType, batch) {
    const userId = doc.id;
...
async function sendUsageLimitNotification(userId, featureName, currentUsage, limit, percentage) {
    try {
    ...
    try {
        ...
        for (const doc of snapshot.docs) {
            ...
            if (usageData[lastMonth]) {
                ...
                batch.set(db.collection('usage_archives').doc(`${doc.id}_${lastMonth}`), archiveData);
            }
            // Clear current month's usage
...
exports.dailySubscriptionHealthCheck = functions.pubsub
    .schedule('0 2 * * *')
    .timeZone('UTC')
    .onRun(async (context) => {
...
exports.weeklyUsageAnalytics = functions.pubsub
    .schedule('0 1 * * 0')
    .timeZone('UTC')
    .onRun(async (context) => {
    ...
    try {
        ...
        for (const usageDoc of usageSnapshot.docs) {
            ...
            const userSubscription = subscriptionsSnapshot.docs.find(sub => sub.data().userId === userId);
...
exports.dailyBillingNotifications = functions.pubsub
    .schedule('0 9 * * *')
    .timeZone('UTC')
    .onRun(async (context) => {
...
async function sendPaymentReminderNotification(userId, invoice) {
    try {
        await db.collection('notifications').add({
            userId,
...
async function sendBillingReminderNotification(userId, nextPaymentDate, invoice) {
    try {
        await db.collection('notifications').add({
            userId,
...
async function sendPaymentFailureNotification(userId, invoice) {
    try {
        await db.collection('notifications').add({
            userId,
            type: 'payment_failed',
...
exports.collectPerformanceMetrics = functions.pubsub
    .schedule('*/5 * * * *')
    .timeZone('UTC')
    .onRun(async (context) => {
    try {
...
exports.generatePerformanceDashboard = functions.https.onCall(async (data, context) => {
    // Verify admin access (in production, add proper admin verification)
    if (!context.auth) {
        throw new functions.https.HttpsError('unauthenticated', 'Must be authenticated to access dashboard');
    }
    try {
        ...
        const recentAlerts = dashboard.alerts.filter(alert => alert.severity === 'high' || alert.severity === 'critical');
...
exports.monitorPaymentSecurity = functions.pubsub
    .schedule('*/10 * * * *')
    .timeZone('UTC')
    .onRun(async (context) => {
...
exports.secureStripeWebhook = functions.https.onRequest(async (req, res) => {
    ...
    try {
        ...
        event = stripe.webhooks.constructEvent(req.rawBody, // Pass Buffer directly
        sig, endpointSecret);
...
async function logWebhookSecurity(event, req) {
    try {
        const securityLog = {
...
Object.defineProperty(exports, "createTicketCheckoutSession", { enumerable: true, get: function () { return ticketing_1.createTicketCheckoutSession; } });
Object.defineProperty(exports, "validateTicket", { enumerable: true, get: function () { return ticketing_1.validateTicket; } });
Object.defineProperty(exports, "getEventTicketSummary", { enumerable: true, get: function () { return ticketing_1.getEventTicketSummary; } });
Object.defineProperty(exports, "cancelTicketPurchase", { enumerable: true, get: function () { return ticketing_1.cancelTicketPurchase; } });
// ====== SQUARE OAUTH FUNCTIONS ======
// Export Square OAuth integration functions
var square_oauth_1 = require("./square-oauth");
Object.defineProperty(exports, "exchangeSquareToken", { enumerable: true, get: function () { return square_oauth_1.exchangeSquareToken; } });
Object.defineProperty(exports, "refreshSquareTokens", { enumerable: true, get: function () { return square_oauth_1.refreshSquareTokens; } });
Object.defineProperty(exports, "disconnectSquare", { enumerable: true, get: function () { return square_oauth_1.disconnectSquare; } });
// ====== SQUARE PAYMENTS SYNC FUNCTIONS ======
// Export Square payment sync functions
var square_payments_sync_1 = require("./square-payments-sync");
Object.defineProperty(exports, "syncSquarePayments", { enumerable: true, get: function () { return square_payments_sync_1.syncSquarePayments; } });
Object.defineProperty(exports, "triggerSquareSync", { enumerable: true, get: function () { return square_payments_sync_1.triggerSquareSync; } });
// ====== STRIPE CONNECT FUNCTIONS ======
// Export Stripe Connect integration functions for vendor payments
var stripe_connect_1 = require("./stripe-connect");
Object.defineProperty(exports, "createStripeConnectAccount", { enumerable: true, get: function () { return stripe_connect_1.createStripeConnectAccount; } });
Object.defineProperty(exports, "checkStripeAccountStatus", { enumerable: true, get: function () { return stripe_connect_1.checkStripeAccountStatus; } });
Object.defineProperty(exports, "disconnectStripeAccount", { enumerable: true, get: function () { return stripe_connect_1.disconnectStripeAccount; } });
Object.defineProperty(exports, "getStripeAccountLink", { enumerable: true, get: function () { return stripe_connect_1.getStripeAccountLink; } });
// Organizer Stripe Connect (receives application payments)
Object.defineProperty(exports, "createOrganizerStripeConnectAccount", { enumerable: true, get: function () { return stripe_connect_1.createOrganizerStripeConnectAccount; } });
Object.defineProperty(exports, "checkOrganizerStripeAccountStatus", { enumerable: true, get: function () { return stripe_connect_1.checkOrganizerStripeAccountStatus; } });
Object.defineProperty(exports, "disconnectOrganizerStripeAccount", { enumerable: true, get: function () { return stripe_connect_1.disconnectOrganizerStripeAccount; } });
Object.defineProperty(exports, "getOrganizerStripeAccountLink", { enumerable: true, get: function () { return stripe_connect_1.getOrganizerStripeAccountLink; } });
// ====== STRIPE PREORDER PAYMENTS ======
// Export Stripe preorder payment processing functions
var stripe_preorder_payments_1 = require("./stripe-preorder-payments");
Object.defineProperty(exports, "createPreorderPaymentIntent", { enumerable: true, get: function () { return stripe_preorder_payments_1.createPreorderPaymentIntent; } });
Object.defineProperty(exports, "getPreorderPaymentStatus", { enumerable: true, get: function () { return stripe_preorder_payments_1.getPreorderPaymentStatus; } });
Object.defineProperty(exports, "cancelPreorderPayment", { enumerable: true, get: function () { return stripe_preorder_payments_1.cancelPreorderPayment; } });
// ====== STRIPE CONNECT WEBHOOKS ======
// Export Stripe Connect webhook handlers
var stripe_connect_webhooks_1 = require("./stripe-connect-webhooks");
Object.defineProperty(exports, "stripeConnectWebhook", { enumerable: true, get: function () { return stripe_connect_webhooks_1.stripeConnectWebhook; } });
Object.defineProperty(exports, "testStripeWebhook", { enumerable: true, get: function () { return stripe_connect_webhooks_1.testStripeWebhook; } });
// ====== STRIPE PAYMENTS SYNC FUNCTIONS ======
// Export Stripe payment sync functions (syncs preorders to vendor_sales)
var stripe_payments_sync_1 = require("./stripe-payments-sync");
Object.defineProperty(exports, "syncStripePreorderToSales", { enumerable: true, get: function () { return stripe_payments_sync_1.syncStripePreorderToSales; } });
Object.defineProperty(exports, "backfillStripePreordersToSales", { enumerable: true, get: function () { return stripe_payments_sync_1.backfillStripePreordersToSales; } });
Object.defineProperty(exports, "getVendorSalesSummary", { enumerable: true, get: function () { return stripe_payments_sync_1.getVendorSalesSummary; } });
 ...
 */
exports.onVendorPostDeleted = functions.firestore
    ...
    try {
        ...
        if (basketResult.affectedUsers.length > 0 || reservationResult.affectedUsers.length > 0) {
            await notifyAffectedUsers(postId, postData, [...new Set([...basketResult.affectedUsers, ...reservationResult.affectedUsers])]);
        }
    }
    catch (error) {
 ...
 */
async function cleanupBasketItems(postId, postData) {
    const affectedUsers = [];
    let deletedCount = 0;
    try {
 ...
 */
async function cleanupPendingReservations(postId, postData) {
    const affectedUsers = [];
 ...
 */
async function notifyAffectedUsers(postId, postData, affectedUserIds) {
    try {
 ...
 */
exports.scheduledBasketCleanup = functions.pubsub
    .schedule('0 2 * * *')
    .timeZone('UTC')
    .onRun(async (context) => {
...
exports.mondayMorningReminders = functions.pubsub
...
exports.thursdayMorningReminders = functions.pubsub
...
async function sendScheduledPopupReminders(reminderType) {
    const now = new Date();
...
async function getVendorsWithUpcomingMarkets(startDate, endDate) {
    const vendorData = [];
    try {
...
async function getOrganizersWithUpcomingMarkets(startDate, endDate) {
    const organizerData = [];
    const now = new Date();
    try {
...
async function checkVendorMarketRelationship(vendorId, marketId) {
    try {
...
async function sendVendorPopupReminder(vendorInfo, reminderType) {
    try {
...
async function sendOrganizerMarketReminder(organizerInfo, reminderType) {
    try {
...
exports.triggerPopupReminders = functions.https.onCall(async (data, context) => {
...
Object.defineProperty(exports, "sendOrderConfirmationEmail", { enumerable: true, get: function () { return emails_1.sendOrderConfirmationEmail; } });
Object.defineProperty(exports, "sendTicketConfirmationEmail", { enumerable: true, get: function () { return emails_1.sendTicketConfirmationEmail; } });
Object.defineProperty(exports, "sendOrderStatusUpdateEmail", { enumerable: true, get: function () { return emails_1.sendOrderStatusUpdateEmail; } });
Object.defineProperty(exports, "sendVendorApplicationConfirmationEmail", { enumerable: true, get: function () { return emails_1.sendVendorApplicationConfirmationEmail; } });
Object.defineProperty(exports, "testEmailFunction", { enumerable: true, get: function () { return emails_1.testEmailFunction; } });
// Export application management functions
var applications_1 = require("./applications");
Object.defineProperty(exports, "expireApplicationsScheduled", { enumerable: true, get: function () { return applications_1.expireApplicationsScheduled; } });
Object.defineProperty(exports, "onApplicationCreated", { enumerable: true, get: function () { return applications_1.onApplicationCreated; } });
Object.defineProperty(exports, "onApplicationUpdated", { enumerable: true, get: function () { return applications_1.onApplicationUpdated; } });
/**
 * Extract event data from flyer image using Google Cloud Vision API
 * Callable function from Flutter app
 */
exports.extractFlyerData = functions.https.onCall(async (data, context) => {
    try {
        // Verify user is authenticated
        if (!context.auth) {
            throw new functions.https.HttpsError('unauthenticated', 'User must be authenticated');
...
function parseEventData(text) {
    ...
    if (titleCandidates.length > 0) {
        ...
        const title = titleCandidates.find(line => !line.toLowerCase().includes('presented by') &&
